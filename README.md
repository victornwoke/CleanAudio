...
The supplied PRD describes fully native Swift/Kotlin applications. This implementation pack instead uses Expo + React Native + TypeScript for the product UI and application layer because that matches the existing CareerFox workflow. Advanced audio processing is isolated behind typed adapters:
